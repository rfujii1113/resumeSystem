...
// 		projects = projectRepository.findProjectsByUserIdSortedByStartDate(resumeEditDTO.getUserId());
...
// 					if (project.getSelectedHW() == null || project.getSelectedOS() == null) {
// 						cell.setCellValue("");
// 					} else {
// 						cell.setCellValue(String.join(",", project.getSelectedHW()) + ","
// 								+ String.join(",", project.getSelectedOS()));
// 					}
// 					//DB
// 					row = sheet.getRow(16 + x);
// 					cell = row.getCell(7);
// 					if (project.getSelectedDB() == null) {
// 						cell.setCellValue("");
// 					} else {
// 						cell.setCellValue(String.join(",", project.getSelectedDB()));
// 					}
// 					//language
// 					row = sheet.getRow(15 + x);
// 					cell = row.getCell(8);
// 					if (project.getSelectedLanguage() == null) {
// 						cell.setCellValue("");
// 					} else {
// 						cell.setCellValue(String.join(",", project.getSelectedLanguage()));
// 					}
// 					//Tool
// 					row = sheet.getRow(16 + x);
// 					cell = row.getCell(8);
// 					if (project.getSelectedTool() == null) {
// 						cell.setCellValue("");
// 					} else {
// 						cell.setCellValue(String.join(",", project.getSelectedTool()));
// 					}
// 					//Type
// 					row = sheet.getRow(15 + x);
// 					cell = row.getCell(10);
...
// 						cell.setCellValue("");
// 					} else {
// 						cell.setCellValue(String.join(",", project.getProjectType()) + ",");
// 					}
